	...
	public boolean useItem(Playable playable, Item item, boolean forceUse)
	{
		...
		for (SkillHolder skillInfo : skills)
		{
			...
			if (itemSkill != null)
			{
				...
				if ((!itemSkill.hasEffectType(EffectType.SUMMON_PET) && !itemSkill.checkCondition(playable, playable.getTarget())) || playable.isSkillDisabled(itemSkill) || !checkReuse(playable, itemSkill, item))
				{
					continue;
				}
