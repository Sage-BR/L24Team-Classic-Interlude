...
public abstract class Creature extends WorldObject implements ISkillsHolder, IDeletable
{
	...
	public void untransform()
	{
		...
		// 4Team: Tempfix for untransform not showing stats.
	...
	public void doAutoAttack(Creature target)
	{
		...
		try
		{
			...
			// 4Team: Do not move when attack is launched.
			if (isMoving())
			{
	...
	public Skill addSkill(Skill skill)
	{
		...
		if (newSkill != null)
		{
			// 4Team: Keep sublevel on skill level increase.
	...
	public void setXYZ(int newX, int newY, int newZ)
	{
		...
		// 4Team: Prevent moving to nonexistent regions.
