...
public class SkillCaster implements Runnable
{
	...
	public boolean finishSkill()
	{
		...
		if (caster.isPlayer())
		{
			...
			if (((_skill.getMaxSoulConsumeCount() > 0) && !caster.getActingPlayer().decreaseSouls(_skill.getMaxSoulConsumeCount())) || ((_skill.getChargeConsumeCount() > 0) && !caster.getActingPlayer().decreaseCharges(_skill.getChargeConsumeCount())))
			{
				return false;
			}
		}
