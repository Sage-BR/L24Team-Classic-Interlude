...
public class DBInstallerGUI extends JFrame implements DBOutputInterface
{
	...
	public DBInstallerGUI(Connection con)
	{
		...
		icons.add(new ImageIcon(".." + File.separator + "images" + File.separator + "l2j4team_16x16.png").getImage());
		icons.add(new ImageIcon(".." + File.separator + "images" + File.separator + "l2j4team_32x32.png").getImage());
		icons.add(new ImageIcon(".." + File.separator + "images" + File.separator + "l2j4team_64x64.png").getImage());
		icons.add(new ImageIcon(".." + File.separator + "images" + File.separator + "l2j4team_128x128.png").getImage());
		setIconImages(icons);
